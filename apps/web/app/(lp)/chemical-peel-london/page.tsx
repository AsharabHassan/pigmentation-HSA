...
import { testimonialsLondon as testimonials } from "@content/chemical-peel/testimonials";
...
export const metadata: Metadata = {
  title: "Chemical Peels London — Doctor-Led Medical Peels | Harley Street Aesthetics",
  description:
    "Doctor-graded chemical peels in London. Clarity, Renewal, and Glow peels — calibrated to your skin type and concern. Safe for Fitzpatrick I–VI. Free consultation.",
  alternates: { canonical: "/chemical-peel-london" },
  openGraph: {
    title: "The reset your skin's been asking for.",
    description: "Doctor-graded chemical peels in London.",
    url: "/chemical-peel-london",
    type: "website",
    images: [{ url: "/api/og/chemical-peel", width: 1200, height: 630 }],
  },
};

export default function ChemicalPeelLondonLpPage() {
  return (
    <>
      <Hero {...hero} />
      <TrustStrip />
