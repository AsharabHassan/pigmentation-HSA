...
import { testimonialsGlasgow as testimonials } from "@content/skin-glow-drip/testimonials";
...
export const metadata: Metadata = {
  title: "Skin Glow IV Drip Glasgow — Glutathione · Vit C · Doctor-Administered | Harley Street Aesthetics",
  description:
    "Doctor-administered Skin Glow IV drips in Glasgow. Glutathione, high-dose Vitamin C, B-Complex — 6-drip courses with transparent pricing. Safe for Fitzpatrick I–VI.",
  alternates: { canonical: "/skin-glow-drip-glasgow" },
  openGraph: {
    title: "Glow from the inside out.",
    description: "Doctor-administered Skin Glow IV drips in Glasgow.",
    url: "/skin-glow-drip-glasgow",
    type: "website",
    images: [{ url: "/api/og/skin-glow-drip", width: 1200, height: 630 }],
  },
};

export default function SkinGlowDripLpPage() {
  return (
    <>
      <Hero {...hero} />
      <TrustStrip />
